...
var mailer = nodemailer.createTransport({
  ...
  port: 587,
  // ...this used to be for gmail: service: config.mailService,
  auth: {
...
function sendEmail(err, logFields, options) {
  ...
  if (options.amount == 0) text += "Your membership is complimentary for 2020, but we would really appreciate your donation at any level, if you are so inclined. See https://zephyrtransport.org/donate for ways to donate.\n\n";
  ...
  if (options.amount == 0) html += '<br/>Your membership is complimentary for 2020, but we would really appreciate your donation at any level, if you are so inclined. See <a href="https://zephyrtransport.org/donate">zephyrtransport.org/donate</a> for ways to donate.\n\n';
